...
// Agregar un widget personalizado al dashboard con WP Query
add_action('wp_dashboard_setup', 'eit_add_custom_dashboard_widget_drafts');

function eit_add_custom_dashboard_widget_drafts() {
  wp_add_dashboard_widget('custom_dashboard_widget_draft', 'Eventos en borrador', 'eit_render_custom_dashboard_widget_drafts');
}

// Función para renderizar el contenido del widget
function eit_render_custom_dashboard_widget_drafts() {
  ...
  if ($query->have_posts()) {
      ...
      echo 'No hay eventos en borrador.';
  }
}